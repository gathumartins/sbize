      ...
      <article className="">
          ...
          <div className="container gap-y-6 grid xs:grid-cols-2 lg:grid-cols-4  [&_h6]:text-sorange [&_h6]:uppercase [&_h6]:mb-2 [&_h6]:text-lg [&_h6]:font-semibold">
            <div>
              ...
              <ul className="text-white">
                <li>
                  <Link
                    href="/"
                    className="text-white text-base hover:text-sorange uppercase leading-9"
                  >
                    Home
                  </Link>
                </li>
                ...
                <li>
                  <Link
                    href="#top"
                    className="text-saccent font-bold text-base hover:text-swhite uppercase leading-9"
                  >
                    Back To Top
                  </Link>
                </li>
              ...
              <ul className="leading-8 text-base">
                <li>
                  <Link
                    ...
                    className="text-white hover:text-sorange"
                  >
                    info@nairobits.com
                  </Link>
                </li>
                ...
                <li className="leading-6 text-white text-base">
                  Covenant Guest House, <br />
                  Gate No. 18, Off Ngong Road
                </li>
                  ...
                  <ul className="flex justify-between gap-4 mt-2">
                    <li>
                      <Link
                        href=""
                        target="_blank"
                        className="text-white hover:text-sorange cursor-pointer"
                      >
            ...
            <div className="[&_h6]:text-sorange [&_h6]:uppercase [&_h6]:mb-4 [&_h6]:text-lg [&_h6]:font-semibold">
              ...
              <ul className="grid grid-cols-1 gap-y-4">
                ...
                <li>
                  <Link
                    href="https://www.nairobits.com/donate"
                    className="inline-block min-w-[140px] accentBtn"
                    target="_blank"
                  >
                    Donate
                  </Link>
            ...
            <div>
              ...
              <p className="text-white mb-4 text-lg">
                ...
                <br className="xs:inline-block hidden" /> & stay updated
              </p>
              <form action="" className="flex flex-col gap-2 sm:max-w-[300px]">
                <section className="flex flex-col gap-4 lg:flex-row lg:gap-2">
                  ...
                  <input
                    ...
                    className="p-2 focus:ring-0 focus:shadow-none placeholder:text-sdarkblue text-foreground rounded-lg flex-grow"
                  />
                  <input
                    type="submit"
                    value="Subscribe"
        ...
        <section className="bg-sprimary py-4">
          <div className="container text-center">
            <p className="text-white text-base sm:text-lg font-mainFont">
