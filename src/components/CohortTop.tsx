...
function CohortTop({data}:any) {
  return (
    <section className="bg-sgray even:bg-white pt-8 group">
        ...
        {data.categoriesFields.heroImage.categoryVideo !== null &&(
            <div className="flex-grow w-full md:w-1/2">
                <iframe allow='fullscreen' className="w-full aspect-video rounded-lg" src={data.categoriesFields.heroImage.categoryVideo}></iframe>
            </div>
        )}
        </article>
    </section>
